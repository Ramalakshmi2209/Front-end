    ...
    <?php if ($_GET['step'] == '2'){?>
  	<div class='lets-wrapper'>
  		<div class='step-letsgo'>
  			...
  			<p style="font-size:22px;">Welcome to TwitVille, where the world comes to you in real-time. Experience the pulse of the planet with trending topics, breaking news, and engaging conversations tailored just for you.

</p>
  			<br>
  			<p style="font-size:22px;">
			  Discover what's buzzing in the TwitVille community! Share your passions and interests, and we'll curate a personalized feed filled with the latest updates and discussions from around the globe.
  			</p>
  			<span>
